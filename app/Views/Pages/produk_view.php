...
<thead>
	...
	<th scope="col">hrg_pengurangan</th>
	<th scope="col">hrg_setelah</th>
...
<tbody>
	...
	<td><?php echo $produk['hrg_pengurangan']-($produk['harga']*$produk['diskon']/100) ?></td> 
	<td><?php echo $produk['harga'] =($produk['harga']+$produk['hrg_pengurangan']) ?></td> 
		...
		<div class="modal-dialog modal-dialog-centered">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="text" name="diskon" class="form-control" id="diskon" value="<?= $produk['diskon'] ?>" placeholder="diskon" required>
				</div>
				<div class="form-group">
					<label for="name">hrg_setelah</label>
					<input type="text" name="hrg_setelah" class="form-control" id="hrg_setelah" value="<?= $produk['hrg_setelah'] ?>" placeholder="hrg_setelah" required>
				</div>
				<div class="form-group">
...
<div class="modal fade" id="addModal" tabindex="-1">
	<div class="modal-dialog modal-dialog-centered">
		...
		<div class="modal-body">
			...
			<div class="form-group">
				<label for="name">hrg_setelah</label>
				<input type="text" name="hrg_setelah" class="form-control" id="hrg_setelah" placeholder="hrg_setelah" required>
			</div>
			<div class="form-group">
				<label for="name">Keterangan</label>
