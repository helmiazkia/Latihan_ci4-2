...
<div class="row">
    <?php foreach ($produks as $index => $produk) : ?>
        <div class="col-lg-6">
            ...
            echo form_hidden('hrg_setelah', $produk['hrg_setelah']);
            echo form_hidden('foto', $produk['foto']);
            ?>
            <div class="card">
                <div class="card-body">
                    <img src="<?php echo base_url() . "public/img/" . $produk['foto'] ?>" alt="..." width="300px">
                    <h5 class="card-title"><?php echo $produk['nama'] ?><br><?php echo number_to_currency($produk['harga'], 'IDR') ?><br><?php echo $produk['hrg_setelah'] ?>
                </h5>
